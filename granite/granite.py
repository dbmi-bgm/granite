...
def main():
    ...
    whiteList_parser.add_argument('--CLINVARonly', help='CLINVAR "CLINSIG" tags or keywords to be saved. Sets for whitelist only CLINVAR variants with specified tags or keywords', nargs='+', required=False)
