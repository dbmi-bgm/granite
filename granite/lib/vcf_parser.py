...
class Vcf(object):
    ...
    def parse_variants(self, inputfile=None): # generator
    ...
    def write_variant(self, outputfile_obj, parsed_variant):
        ''' write parsed variant (items generated by parse_variants) to file.
