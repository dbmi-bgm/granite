...
def test_run_cleanVCF_VEP_SpAI_remove_rescue_tag_bis():
    ...
    args = {'inputfile': 'tests/files/input_cleanVCF_SpAI.vcf', 'outputfile': 'tests/files/main_test.out',
            ...
            'VEPremove': None, 'VEPtag': None, 'tag': ['BaseQRankSum'], 'verbose': None, 'VEPsep': None, 'SpliceAItag': None}
    # Run
    main_cleanVCF(args)
    # Tests
...
def test_run_cleanVCF_VEP_SpAI_remove_rescue_tag_bis_sep():
    ...
    args = {'inputfile': 'tests/files/input_cleanVCF_SpAI_sep.vcf', 'outputfile': 'tests/files/main_test.out',
            'SpliceAI': 0.9, 'VEP': True, 'VEPrescue': ['downstream_gene_variant', 'NMD_transcript_variant'],
            'VEPremove': None, 'VEPtag': None, 'tag': ['BaseQRankSum'], 'verbose': None, 'VEPsep': '~', 'SpliceAItag': None}
    # Run
    main_cleanVCF(args)
    # Tests
...
def test_run_cleanVCF_VEP_remove_rescue():
    ...
    args = {'inputfile': 'tests/files/input_cleanVCF.vcf', 'outputfile': 'tests/files/main_test.out',
            ...
            'VEPremove': ['5_prime_UTR_variant', '3_prime_UTR_variant'], 'VEPtag': None, 'tag': [], 'verbose': None, 'VEPsep': None, 'SpliceAItag': None}
    # Run
    main_cleanVCF(args)
    # Tests
...
def test_run_cleanVCF_VEP_SpAI_remove_rescue_tag():
    ...
    args = {'inputfile': 'tests/files/input_cleanVCF_SpAI.vcf', 'outputfile': 'tests/files/main_test.out',
            'SpliceAI': 0.9, 'VEP': True, 'VEPrescue': ['downstream_gene_variant', 'NMD_transcript_variant'],
            'VEPremove': ['5_prime_UTR_variant', '3_prime_UTR_variant'], 'VEPtag': None, 'tag': ['BaseQRankSum'], 'verbose': None, 'VEPsep': None, 'SpliceAItag': None}
    # Run
    main_cleanVCF(args)
    # Tests
...
def test_run_cleanVCF_VEP_SpAI_remove_rescue_tag_2():
    ...
    args = {'inputfile': 'tests/files/input_cleanVCF_SpAI.vcf', 'outputfile': 'tests/files/main_test.out',
            'SpliceAI': 0.9, 'VEP': True, 'VEPrescue': ['downstream_gene_variant', 'NMD_transcript_variant'],
            'VEPremove': ['5_prime_UTR_variant', '3_prime_UTR_variant'], 'VEPtag': None, 'tag': ['BaseQRankSum', 'novoCaller'], 'verbose': None, 'VEPsep': None, 'SpliceAItag': None}
    # Run
    main_cleanVCF(args)
    # Tests
...
def test_run_cleanVCF_VEP_SpAI_SpAItag_remove_rescue_tag_2():
    ...
    args = {'inputfile': 'tests/files/input_cleanVCF_SpAI_SpAItag.vcf', 'outputfile': 'tests/files/main_test.out',
            'SpliceAI': 0.9, 'VEP': True, 'VEPrescue': ['downstream_gene_variant', 'NMD_transcript_variant'],
            'VEPremove': ['5_prime_UTR_variant', '3_prime_UTR_variant'], 'VEPtag': None, 'tag': ['BaseQRankSum', 'novoCaller'], 'verbose': None, 'VEPsep': None, 'SpliceAItag': 'VALUE_MAX'}
    # Run
    main_cleanVCF(args)
    # Tests
