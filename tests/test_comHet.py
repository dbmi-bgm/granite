...
def test_run_comHet_proband(): # NA12879
    ...
    args = {'inputfile': 'tests/files/input_comHet.vcf', 'outputfile': 'tests/files/main_test.out',
            'trio': ['NA12879_sample'], 'VEPtag': None, 'allow_undef': None, 'filter_comHet': True, 'verbose': None, 'sep': None}
    # Run
    main_comHet(args)
    # Tests
...
def test_run_comHet_proband_plus_NA12877():
    ...
    # Variables
    args = {'inputfile': 'tests/files/input_comHet.vcf', 'outputfile': 'tests/files/main_test.out',
            'trio': ['NA12879_sample', 'NA12877_sample'], 'VEPtag': None, 'allow_undef': None, 'filter_comHet': True, 'verbose': None, 'sep': None}
    # Run
    main_comHet(args)
    # Tests
...
def test_run_comHet_proband_plus_NA12878():
    ...
    # Variables
    args = {'inputfile': 'tests/files/input_comHet.vcf', 'outputfile': 'tests/files/main_test.out',
            'trio': ['NA12879_sample', 'NA12878_sample'], 'VEPtag': None, 'allow_undef': None, 'filter_comHet': True, 'verbose': None, 'sep': None}
    # Run
    main_comHet(args)
    # Tests
...
def test_run_comHet_proband_plus_NA12877_NA12878():
    ...
    # Variables
    args = {'inputfile': 'tests/files/input_comHet.vcf', 'outputfile': 'tests/files/main_test.out',
            'trio': ['NA12879_sample', 'NA12877_sample', 'NA12878_sample'], 'VEPtag': None, 'allow_undef': None, 'filter_comHet': True, 'verbose': None, 'sep': None}
    # Run
    main_comHet(args)
    # Tests
...
def test_run_comHet_proband_VEP_as_CSQ_plus_NA12877_NA12878():
    ...
    args = {'inputfile': 'tests/files/input_comHet_VEP_as_CSQ.vcf', 'outputfile': 'tests/files/main_test.out',
            'trio': ['NA12879_sample', 'NA12877_sample', 'NA12878_sample'], 'VEPtag': 'CSQ', 'allow_undef': None, 'filter_comHet': True, 'verbose': None, 'sep': None}
    # Run
    main_comHet(args)
    # Tests
...
def test_run_comHet_proband_plus_NA12877_allow_undef():
    ...
    # Variables
    args = {'inputfile': 'tests/files/input_comHet.vcf', 'outputfile': 'tests/files/main_test.out',
            'trio': ['NA12879_sample', 'NA12877_sample'], 'VEPtag': None, 'allow_undef': True, 'filter_comHet': True, 'verbose': None, 'sep': None}
    # Run
    main_comHet(args)
    # Tests
...
def test_run_comHet_proband_plus_NA12878_allow_undef():
    ...
    # Variables
    args = {'inputfile': 'tests/files/input_comHet.vcf', 'outputfile': 'tests/files/main_test.out',
            'trio': ['NA12879_sample', 'NA12878_sample'], 'VEPtag': None, 'allow_undef': True, 'filter_comHet': True, 'verbose': None, 'sep': None}
    # Run
    main_comHet(args)
    # Tests
...
def test_run_comHet_proband_plus_NA12878_NA12877_allow_undef():
    ...
    # Variables
    args = {'inputfile': 'tests/files/input_comHet.vcf', 'outputfile': 'tests/files/main_test.out',
            'trio': ['NA12879_sample', 'NA12878_sample', 'NA12877_sample'], 'VEPtag': None, 'allow_undef': True, 'filter_comHet': True, 'verbose': None, 'sep': None}
    # Run
    main_comHet(args)
    # Tests
...
def test_run_comHet_NA12878():
    ...
    # Variables
    args = {'inputfile': 'tests/files/input_comHet.vcf', 'outputfile': 'tests/files/main_test.out',
            'trio': ['NA12878_sample'], 'VEPtag': None, 'allow_undef': None, 'filter_comHet': True, 'verbose': None, 'sep': None}
    # Run
    main_comHet(args)
    # Tests
...
def test_run_trio_error(): # NA12879
    ...
    # Variables
    args = {'inputfile': 'tests/files/input_comHet.vcf', 'outputfile': 'tests/files/main_test.out',
            'trio': ['NA12879_sample', 'NA12878_sample', 'NA12877_sample', 'extra_sample'], 'VEPtag': None, 'allow_undef': None, 'filter_comHet': True, 'verbose': None, 'sep': None}
    # Run and Tests
