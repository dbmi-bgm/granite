...
def test_run_validateVCF_het():
    ...
    # Check run is successful
    assert os.path.exists('tests/files/main_test.out')
    assert os.path.exists('autosomal_heterozygous_accuracy_family_UGRP1_ind_5_GAPFIR4IUBTH-UGRP1_ind_6_GAPFIR4IUBTH.png')
    assert os.path.exists('autosomal_heterozygous_distribution_family_UGRP1_ind_5_GAPFIR4IUBTH-UGRP1_ind_6_GAPFIR4IUBTH.png')
    assert os.path.exists('autosomal_heterozygous_distribution_trio_UGRP1_ind_5_GAPFIR4IUBTH-UGRP1_ind_6_GAPFIR4IUBTH.png')
    # Clean
